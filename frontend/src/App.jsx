                                    ...
                                    <div className="space-y-3 pt-2">
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-slate-800 hover:bg-rose-500/20 hover:text-rose-400 
                                                border border-slate-700 active:scale-95 text-slate-300 font-bold py-2 rounded-xl text-sm 
                                                transition-all cursor-pointer">Sell Asset        
                                    </div>
                                </div>
                            ))}
                        </div>
